<template>
	<v-row>
		...
		<v-col cols="4" offset="2">
			<v-checkbox
				v-model="localRgbCameraChecked"
				@change="updateRgbCameraChecked($event.target.checked)"
				label="RGB kamera"
				color="#77BE13"
			></v-checkbox>
			<v-select
				v-model="localSelectedSensorCount"
				variant="underlined"
				label="Počet senzorů"
				:items="rgbCameraSensors"
...
const emits = defineEmits([
	...
	'update:rgbCameraChecked',
	'update:measurementDuration',
	'update:selectedSensorCount',
]);
